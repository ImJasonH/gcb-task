...
import (
	...
	fake "github.com/imjasonh/gcb-task/pkg/client/cloudbuild/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/imjasonh/gcb-task/pkg/client/cloudbuild/clientset/versioned/fake.Clientset from context.")
	}
