...
type reconcilerImpl struct {
	...
	Lister cloudbuildv1alpha1.RunLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister cloudbuildv1alpha1.RunLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.Run, desired *v1alpha1.Run) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.CloudbuildV1alpha1().Runs(desired.Namespace)
		...
		updater := r.Client.CloudbuildV1alpha1().Runs(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Run) (*v1alpha1.Run, error) {
	...
	patcher := r.Client.CloudbuildV1alpha1().Runs(resource.Namespace)
