...
import (
	...
	build "github.com/imjasonh/gcb-task/pkg/client/cloudbuild/injection/reconciler/cloudbuild/v1alpha1/build"
...
// reason BuildReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "BuildReconciled", "Build reconciled: \"%s/%s\"", namespace, name)
}
...
var _ build.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ build.Finalizer = (*Reconciler)(nil)
...
//var _ build.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ build.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.Build) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.Build) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.Build) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.Build) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
