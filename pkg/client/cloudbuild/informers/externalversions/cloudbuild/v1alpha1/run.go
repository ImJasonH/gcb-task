...
import (
	...
	cloudbuildv1alpha1 "github.com/imjasonh/gcb-task/pkg/apis/cloudbuild/v1alpha1"
	versioned "github.com/imjasonh/gcb-task/pkg/client/cloudbuild/clientset/versioned"
	internalinterfaces "github.com/imjasonh/gcb-task/pkg/client/cloudbuild/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/imjasonh/gcb-task/pkg/client/cloudbuild/listers/cloudbuild/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudbuildV1alpha1().Runs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudbuildV1alpha1().Runs(namespace).Watch(options)
			},
		},
		&cloudbuildv1alpha1.Run{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *runInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudbuildv1alpha1.Run{}, f.defaultInformer)
}
