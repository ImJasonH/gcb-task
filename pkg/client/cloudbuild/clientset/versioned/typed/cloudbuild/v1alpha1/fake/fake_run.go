...
var runsResource = schema.GroupVersionResource{Group: "cloudbuild", Version: "v1alpha1", Resource: "runs"}

var runsKind = schema.GroupVersionKind{Group: "cloudbuild", Version: "v1alpha1", Kind: "Run"}
